...
export const metadata: Metadata = {
  title: "Blog Details | Glass Loan Management Software",
  description: "Blog Details Page for Glass Loan Management Software",
  // other metadata
};
            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                ...
                <div className="mb-10 flex flex-wrap items-center justify-between border-b border-body-color border-opacity-10 pb-4 dark:border-white dark:border-opacity-10">
                  <div className="flex flex-wrap items-center">
                    ...
                    <div className="mb-5 flex items-center">
                      <p className="mr-5 flex items-center text-base font-medium text-body-color dark:text-body-color-dark">
                        <span className="mr-3">
                          <svg
                            width="15"
                            height="15"
                      ...
                      <p className="flex items-center text-base font-medium text-body-color dark:text-body-color-dark">
                        <span className="mr-3">
                          <svg
                            width="20"
                            height="12"
                ...
                <div>
                  ...
                  <p className="mb-8 text-base font-medium leading-relaxed text-body-color dark:text-body-color-dark sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                  ...
                  <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:p-8 xl:p-9">
                    <p className="text-center text-base font-medium italic text-body-color dark:text-body-color-dark">
                  ...
                  <div className="items-center justify-between sm:flex">
                    <div className="mb-5">
                      <h4 className="mb-3 text-sm font-medium text-body-color dark:text-body-color-dark">
                        Popular Tags :
                      </h4>
