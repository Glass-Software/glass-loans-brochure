...
import { PricingCardProps } from "@/types/stripe";
...
const PricingCard = ({
  ...
  const duration = period === "month" ? "mo" : "yr";

  return (
    <div className="w-full">
      <div
        className={`relative rounded-sm bg-white px-8 py-10 shadow-three hover:shadow-one dark:bg-gray-dark dark:shadow-two dark:hover:shadow-gray-dark ${
      ...
      >
        ...
        <div className="mb-7 border-b border-body-color border-opacity-10 pb-7 dark:border-white dark:border-opacity-10">
          <button
            onClick={onSelect}
